...
public class FilteringDynamicApplication {

    public static void main(String[] args) {
        SpringApplication.run(FilteringDynamicApplication.class, args);
    }
    @Bean
   public CommandLineRunner specificationsDemo(MovieRepository movieRepository){
        return  args -> {
            ...
            msTitleRating.add(new SearchCriteria("rating", 7.0, SearchOperation.GREATER_THAN));
